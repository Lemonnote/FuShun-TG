...
Public Class CallLA302_
    ...
    Public WaitforCheckD1D2 As New Timer
            ...
            Select Case State
                ...
                Case CallLA302.CheckReady
                    ...
                    Else
                        ...
                        '============================================09/13
                        'WaitforCheckD1D2.TimeRemaining = 10
                        '.LA302FReadSQLFlag = True
                        '===========================================
          End If

        Case CallLA302.DispenseWaitReady
          'TODO  Add timeout code to switch to manual if no response
                    If ControlCode.ChemicalState = EDispenseState.Ready Then
                ...
                Case CallLA302.WaitDispenseReady
                    If .WaitFor302D Then
                        ...
                        End If
                    Else
                        If ControlCode.Parameters.ChemicalEnable = 1 And ControlCode.BTankLowLevel Then
                            ' WaitTimer.TimeRemaining = .Parameters.ChemicalTransferDelayTime
                            State = CallLA302.Ready

                        End If
            If ControlCode.Parameters.ChemicalEnable = 2 And (.CTankLowLevel And .Parameters.C藥缸水位種類 = 0) Or (.Parameters.C藥缸水位種類 = 1 And .IO.CTankLow) Then
              ' WaitTimer.TimeRemaining = .Parameters.ChemicalTransferDelayTime
              State = CallLA302.Ready
            End If
                    End If
