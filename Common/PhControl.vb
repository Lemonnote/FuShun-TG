        ...
        Try
            ...
            PhPumpOutRatio = CType((.Parameters.PhPumpOutRatio * 3) / 60, Double) 'PH泵加酸比
                        ...
                        If (((.Command01.Gradient <> 0 Or .Command76.State = Command76.S76.Start) And .Command01.IsOn = True) Or .Command80.State = Command80.S80.Start) Then
                            ...
                            '  TotalAddHac2 = CType(CalculateTmepRange * 0.9, Integer)     '新增加
                            ...
                            X = FirstPhValue - C75Gradient          'X= 2    實際pH8 - 目標pH6 = 2
...
123:
                    ...
                    Case PhControl.MathAddHac3
                        ...
                        If Not WaitAddHac.Finished Then
                            If ControlCode.IO.pHValue - 5 < ExpectPh Or ControlCode.IO.pHValue < C75Gradient Then        ' 800<797
                                OpenHacValve = False
                    ...
                    Case PhControl.MathAddHac4
                        ...
                        If WaitAddHac.Finished Then                         '開閥 HAC 比方說7秒
                            If ControlCode.IO.pHValue <= 455 Then
                                If ControlCode.IO.pHValue - 1 < ExpectPh Or ControlCode.IO.pHValue < C75Gradient Then
                                    OpenHacValve = False                            '關閉 HAC
                                Else
                                    OpenHacValve = True                            '關閉 HAC
                                End If
                            Else
                                OpenHacValve = False                            '關閉 HAC
                            End If
