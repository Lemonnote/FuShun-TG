'<Command("ParallelDiluteAdd B", "Time |0-60|", , , "'1", CommandType.ParallelCommand), _
' TranslateCommand("zh-TW", "平行B稀釋加藥", "加藥時間 |0-60|"), _
    ...
    With ControlCode
      ...
      Select Case State
        ...
        Case S61.WaitAddTimeRunback
          ...
          If Not .IO.TankBLevel > 800 Then RunBackWait.TimeRemaining = 2
          If .IO.TankBLevel > 800 And RunBackWait.Finished Then
            State = S61.WaitAddTimeHold
          End If
          'pause if halted or pump not runnng
          If .Parent.IsPaused Or Not .IO.MainPumpFB Then
...
#Region "Standard Definitions"
  ...
  Public ReadOnly Property IsTransfer() As Boolean
    Get
      Return ((State = S61.WaitWashSTank) Or (State = S61.WaitNotTankLowLevel2) Or (State = S61.WaitNotTankLowLevel))
    End Get
  End Property
  Public ReadOnly Property IsMixing() As Boolean
    Get
      Return ((State = S61.WaitTankReady) Or (State = S61.WaitAddTimeRunback) Or (State = S61.WaitAddTimeHold) Or (State = S61.WaitAddTimeTranfer))
    End Get
  End Property
  ...
  Public ReadOnly Property IsDraining() As Boolean
    Get
      Return ((State = S61.WaitWashSTank2) Or (State = S61.WaitAddFinish3))
    End Get
  End Property
