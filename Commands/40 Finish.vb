<Command("Finish", , , , ), _
 TranslateCommand("zh-TW", "染程結束")> _
Public NotInheritable Class Command40
    ...
    Public Function Run() As Boolean Implements ACCommand.Run
        With ControlCode
            Select Case State
                ...
                Case S39.WaitAuto
                    StateString = If(.Language = LanguageValue.ZhTw, "染程結束，請按確認鈕！", "Rinsing")
...
#Region "Standard Definitions"
    ...
    Friend ReadOnly Property IsOn() As Boolean Implements ACCommand.IsOn
        Get
            Return State <> S39.Off
        End Get
    End Property


    <EditorBrowsable(EditorBrowsableState.Advanced)> Private state_ As S39
    Public Property State() As S39
        Get
            Return state_
        End Get
        Private Set(ByVal value As S39)
            state_ = value
        End Set
    End Property
#End Region
...
Partial Public Class ControlCode
    Public ReadOnly Command39 As New Command39(Me)
End Class
#End Region
