<Command("Power Drain", "Pump Delay |0-60| Drain Type |0-1| Speed |1-100|%", , "30", "5"), _
 TranslateCommand("zh-TW", "動力排水 ", "啟動延遲 |0-60|秒, 水管|0-1|, 運轉速度 |1-100|%"), _
 Description("MAX=60s,MIN=0s 1=HOT 0=COLD   MAX=100% ,MIN=1%"), _
...
Public NotInheritable Class Command32
  ...
  Public Function Start(ByVal ParamArray param() As Integer) As Boolean Implements ACCommand.Start
    With ControlCode
      .Command16.Cancel() : .Command02.Cancel() : .Command10.Cancel() : .Command03.Cancel() : .Command04.Cancel() : .Command01.Cancel()
  ...
  Public Function Run() As Boolean Implements ACCommand.Run
    With ControlCode
      Select Case State
        ...
        Case S32.WaitTime4
                    StateString = If(.Language = LanguageValue.ZhTw, "停止主泵", "Stopping pump ") & " " & TimerString(Wait.TimeRemaining)
          If Not Wait.Finished Then Exit Select
          State = S32.WaitLowLevel

        Case S32.WaitLowLevel
          StateString = If(.Language = LanguageValue.ZhTw, "水位不足", "Level to low ")
          If Not .IO.LowLevel Then
