<Command("PhControlTime", "TARGET PH |4-9|.|00-99| ADD TIME |2-60| ", , , "'3", ), _
 TranslateCommand("zh-TW", "PH控制-時間", "PH值設定 |4-9|.|00-99| 加酸時間 |2-60|  "), _
 Description("CONTROL PH MAX=PH 9.9,MIN=PH 4.0  ; ADD TIME MAX=60M MIN=2M  "), _
 TranslateDescription("zh-TW", "PH控制  最高=PH 9.9,最低=PH 4.0  ; 加酸時間 最高=60分 最低=2分 ")> _
